...
{% block codecell %}
<div class="cell border-box-sizing code_cell rendered" id="cell_{{ cell.metadata.cell_id }}">
{{ super() }}
</div>
{%- endblock codecell %}
...
<div class="cell border-box-sizing text_cell rendered" id="cell_{{ cell.metadata.cell_id }}">
